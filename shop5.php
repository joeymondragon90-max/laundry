...
<head>
    <meta charset="UTF-8">
    <title>EP Laundry Hub | Dry Zone Cantilan</title>
...
<main class="shop-detail-container container">
    <div class="shop-detail-header">
        ...
        <div class="shop-detail-info">
            ...
            <div class="shop-info"><i class="fas fa-map-marker-alt"></i> Urbiztondo St., Purok 3 Magosilom, Cantilan</div>
            <div class="shop-info"><i class="fas fa-star rating"></i> 4.6 (98 reviews)</div>
            <div class="shop-desc">
                <p>Complete laundry services with free pickup and delivery within Poblacion area. Fast, reliable, and clean!</p>
            </div>
            <div class="shop-extra">
                <span><b>Daily Orders:</b> ~23 customers</span>
            </div>
        </div>
    </div>
    ...
    <section class="shop-photos">
        ...
        <div class="photos-row">
            <a href="./shop5.1.jpg" class="photo-link"><img src="./shop5.1.jpg" alt="Shop Interior"></a>
            <a href="./shop5.2.jpg" class="photo-link"><img src="./shop5.2.jpg" alt="Machines"></a>
        </div>
    </section>
    <div class="shop-actions">
        <a href="chat.php?shop=EP%20Laundry%20Shop"><button class="btn" id="chatBtn"><i class="fas fa-comments"></i> Chat</button></a>
        <a href="orderform.php?shop=EP%20Laundry%20Shop&return=shop5.php"><button class="btn" id="orderBtn"><i class="fas fa-shopping-cart"></i> Order Now</button></a>
    </div>
    <?php $shop_name = 'EP Laundry Hub'; include 'reviews_inc.php'; ?>
</main>
